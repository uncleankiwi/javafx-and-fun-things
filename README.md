...
### Pi Estimator
This contains:
1. a method for generating fractions ([diophantine approximations](https://en.wikipedia.org/wiki/Diophantine_approximation), to be exact) that are decent estimates of pi, e, or any other number in the 1 < n < 10 range,
